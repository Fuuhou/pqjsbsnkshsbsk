...
FILE_LIST=(
  restore backup menu m-vmess m-vless m-trojan
  m-system m-sshovpn running m-update m-backup m-theme m-ip m-bot update
  ws-dropbear bckpbot tendang bottelegram cleaner m-vmess m-vless m-trojan xraylimit xp trialvmess
