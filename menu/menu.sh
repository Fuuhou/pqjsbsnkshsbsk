...
clear;clear;clear
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}                      ${WH} • WIBU X XIE •                  ${NC} $COLOR1│ $NC"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 OS            ${COLOR1}: ${WH}$MODEL2${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 RAM           ${COLOR1}: ${WH}$tram / $uram MB${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 DATE          ${COLOR1}: ${WH}$DATE2 WIB${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 UPTIME        ${COLOR1}: ${WH}$uphours $upminutes $uptimecek"
echo -e " $COLOR1│$NC${WH} 𖣘 ISP           ${COLOR1}: ${WH}$ISP${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 City          ${COLOR1}: ${WH}$CITY${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 IP VPS        ${COLOR1}: ${WH}$MYIP${NC}"
echo -e " $COLOR1│$NC${WH} 𖣘 DOMAIN        ${COLOR1}: ${WH}$(cat /etc/xray/domain)"
echo -e " $COLOR1│$NC${WH} 𖣘 NSDomain      ${COLOR1}: ${WH}$(cat /etc/xray/dns)"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
...
echo -e "$COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│$NC ${WH} 𖣘 Versi   ${NC}: ${WH}1.0.0 Version${NC}"
echo -e "$COLOR1│$NC ${WH} 𖣘 Client ${NC} : ${WH}$author${NC}"
echo -e "$COLOR1│$NC ${WH} 𖣘 Durasi ${NC} : ${WH}$certificate hari${NC}"
echo -e "$COLOR1│$NC ${WH} 𖣘 Expiry ${NC} : ${WH}$Exp2 $sts ${NC}"
echo -e "$COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e ""
