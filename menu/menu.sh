...
Exp2=$(curl -sS https://raw.githubusercontent.com/Fuuhou/izin/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Fuuhou/pqjsbsnkshsbsk/main/m-update.sh
clear
...
echo -e "   $COLOR1╭═════════════ • ${WH}STATUS SERVER${NC}${COLOR1} • ═════════════╮${NC}"
echo -e "     ${WH} SSH        : ${status_ws}      XRAY      : ${status_xray} ${NC}"
echo -e "     ${WH} NGINX      : ${status_nginx}   DROPBEAR  : ${status_beruangjatuh}${NC}"
echo -e "     ${WH} UDP CUSTOM : ${status_udp}${NC}"
echo -e "   $COLOR1╰════════════════════════════════════════════╯${NC}"

echo -e "     $COLOR1╭════════════ •${NC} ${WH}ACCOUNT PREMIUM${NC} $COLOR1• ═══════════╮${NC}"
printf "                \033[1;37m%-16s ${COLOR1}%-4s${NC} ${WH}%-5s\e[0m\n" " ① SSH    =" "$total_ssh" "ACCOUNT"
printf "                \033[1;37m%-16s ${COLOR1}%-4s${NC} ${WH}%-5s\e[0m\n" " ② VMESS  =" "$vmess" "ACCOUNT"
printf "                \033[1;37m%-16s ${COLOR1}%-4s${NC} ${WH}%-5s\e[0m\n" " ③ VLESS  =" "$vless" "ACCOUNT"
printf "                \033[1;37m%-16s ${COLOR1}%-4s${NC} ${WH}%-5s\e[0m\n" " ④ TROJAN =" "$trtls" "ACCOUNT"
echo -e "     $COLOR1╰═════════════════════════════════════════╯${NC}"

echo -e " $COLOR1╭═══════════════ • ${WH}LIST MENU${NC}${COLOR1} • ════════════════╮${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}SSH        ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}VMESS      ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}VLESS      ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}TROJAN     ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}BOT PANEL  ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}BOT NOTIF  ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}07${WH}]${NC} ${COLOR1}• ${WH}UPDATE     ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}08${WH}]${NC} ${COLOR1}• ${WH}SETTING    ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${WH}BACKUP     ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}REBOOT     ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}RUNNING    ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1│$NC ${WH}[${COLOR1}12${WH}]${NC} ${COLOR1}• ${WH}RESTART    ${WH}[${COLOR1}Menu${WH}]   ${NC}"
echo -e " $COLOR1╰══════════════════════════════════════════════╯${NC}"

echo -e "$COLOR1╭═══════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│$NC  ${WH}📊 Total Bandwidth  ${NC}                    ${NC}"
echo -e "$COLOR1│$NC  ${WH}➤ Today     ${NC}: ${WH}$today_tx $today_txv${NC}"
echo -e "$COLOR1│$NC  ${WH}➤ Yesterday ${NC}: ${WH}$yesterday_tx $yesterday_txv${NC}"
echo -e "$COLOR1│$NC  ${WH}➤ This Month${NC}: ${WH}$month_tx $month_txv${NC}"
echo -e "$COLOR1╰═══════════════════════════════════════════════╯${NC}"

echo -e "$COLOR1╭═══════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│$NC  ${WH}❖ Version    ${NC}: ${WH}1.0.0${NC}"
echo -e "$COLOR1│$NC  ${WH}❖ Client     ${NC}: ${WH}$author${NC}"
echo -e "$COLOR1│$NC  ${WH}❖ Duration   ${NC}: ${WH}$certificate hari${NC}"
