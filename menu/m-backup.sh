...
echo "*/30 * * * *  root /usr/bin/backup-gram" >>/etc/cron.d/autobackup
echo -e ""
echo -e "======================================"
echo -e ""
...
echo "# Autobackup" >/etc/cron.d/autobackup
echo "PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin" >>/etc/cron.d/autobackup
echo "*/60 * * * *  root /usr/bin/backup-gram" >>/etc/cron.d/autobackup
echo -e ""
echo -e "======================================"
echo -e ""
...
echo "# Autobackup" >/etc/cron.d/autobackup
echo "PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin" >>/etc/cron.d/autobackup
echo "*/120 * * * *  root /usr/bin/backup-gram" >>/etc/cron.d/autobackup
echo -e ""
echo -e "======================================"
echo -e ""
...
echo "# Autobackup" >/etc/cron.d/autobackup
echo "PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin" >>/etc/cron.d/autobackup
echo "*/180 * * * *  root /usr/bin/backup-gram" >>/etc/cron.d/autobackup
echo -e ""
echo -e "======================================"
echo -e ""
...
echo "# Autobackup" >/etc/cron.d/autobackup
echo "PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin" >>/etc/cron.d/autobackup
echo "*/240 * * * *  root /usr/bin/backup-gram" >>/etc/cron.d/autobackup
echo -e ""
echo -e "======================================"
echo -e ""
...
10 */${jam2} * * * root /usr/bin/backup-gram
END
service cron restart >/dev/null 2>&1
service cron reload >/dev/null 2>&1
...
SHELL=/bin/sh
PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
0 ${jam2} * * * root /usr/bin/backup-gram
END
service cron restart >/dev/null 2>&1
service cron reload >/dev/null 2>&1
...
read -rp "Enter Token (Get on @BotFather) : " -e token2
echo "$token2" > /usr/bin/token
read -rp "Enter Your Id (Get on @userinfobot)  : " -e idchat
