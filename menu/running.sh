...
data_ip="https://raw.githubusercontent.com/wibuxie/iz/main/ip"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/wibuxie/iz/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
Exp2=$(curl -sS https://raw.githubusercontent.com/wibuxie/iz/main/ip | grep $MYIP | awk '{print $3}')
...
# DNS PATCH
#tipeos2=$(uname -m)
Name2=$(curl -sS https://raw.githubusercontent.com/wibuxie/iz/main/ip | grep $MYIP | awk '{print $2}')
# GETTING DOMAIN NAME
...
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Hostname    ${COLOR1}: ${WH}$HOSTNAME$NC"
echo -e "$COLOR1 $NC  ${WH}𖣘 OS Name     ${COLOR1}: ${WH}$Tipe$NC"
echo -e "$COLOR1 $NC  ${WH}𖣘 Total RAM   ${COLOR1}: ${WH}${totalram}MB$NC"
echo -e "$COLOR1 $NC  ${WH}𖣘 Public IP   ${COLOR1}: ${WH}$MYIP$NC"
echo -e "$COLOR1 $NC  ${WH}𖣘 Domain      ${COLOR1}: ${WH}$Domen$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}${COLBG1}          ${WH}⇱ SUBSCRIPTION INFORMATION ⇲           ${NC}${COLOR1} │$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ $NC ${WH}𖣘 Client Name ${COLOR1}: ${WH}$Name2${NC}"
echo -e "$COLOR1│ $NC ${WH}𖣘 License     ${COLOR1}: ${WH}$certificate days${NC}"
echo -e "$COLOR1│ $NC ${WH}𖣘 Version     ${COLOR1}: ${WH}$(cat /opt/.ver) Version${NC}"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}${COLBG1}              ${WH}⇱ SERVICE INFORMATION ⇲            ${NC}${COLOR1} │$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 SSH / TUN               ${COLOR1}: ${WH}$status_ssh${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 OpenVPN                 ${COLOR1}: ${WH}$status_openvpn${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Dropbear                ${COLOR1}: ${WH}$status_beruangjatuh${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Crons                   ${COLOR1}: ${WH}$status_cron${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Vnstat                  ${COLOR1}: ${WH}$status_vnstat${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 XRAYS Vmess TLS         ${COLOR1}: ${WH}$status_tls_v2ray${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 XRAYS Vmess None TLS    ${COLOR1}: ${WH}$status_nontls_v2ray${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 XRAYS Vless TLS         ${COLOR1}: ${WH}$status_tls_vless${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 XRAYS Vless None TLS    ${COLOR1}: ${WH}$status_nontls_vless${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 XRAYS Trojan            ${COLOR1}: ${WH}$status_virus_trojan${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Shadowsocks             ${COLOR1}: ${WH}$status_shadowsocks${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Websocket TLS           ${COLOR1}: ${WH}$swstls${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Websocket None TLS      ${COLOR1}: ${WH}$swstls${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 Websocket None TLS      ${COLOR1}: ${WH}$swstls${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 NOOBZVPNS               ${COLOR1}: ${WH}$noobz${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 TROJAN-GO               ${COLOR1}: ${WH}$status_trgo${NC}"
echo -e "$COLOR1 $NC  ${WH}𖣘 SSH UDP COSTUM          ${COLOR1}: ${WH}$udp${NC}"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}${COLBG1}              ${WH}⇱ AUTOSCRIPT PREMIUM ⇲             ${NC}${COLOR1} │$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
